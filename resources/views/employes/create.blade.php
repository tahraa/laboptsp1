    ...
    <div class="table-responsive">
      <table class="table table-bordered" id="dynamicAddRemoveC">
        ...
        <tr>
          ...
          <td><select style="width: 160px"t required="required" name="moreFieldsC[0][sexe]" id="" class="form-control"><option {{ old('moreFieldsC[0][sexe]') == 'masculin' ? 'selected' : '' }} value="masculin">masculin</option><option {{ old('moreFieldsC[0][sexe]') == 'feminin' ? 'selected' : '' }} value="feminin">féminin</option></select></td>
      ...
      <div class="table-responsive">
        <table class="table table-bordered" id="dynamicAddRemoveE">
          ...
          <tr>
            ...
            <td><select style="width: 160px" required="required" name="moreFieldsE[0][scolarite]" id="" class="form-control"><option value="1">scolarisé</option><option value="0">non scolarisé</option></select></td>
            ...
            <td><input style="width: 200px" required="required"  type="date" name="moreFieldsE[0][date_naissance]" class="form-control" /></td>
            <td><input style="width: 300px" required="required" type="file" name="moreFieldsE[0][e_image]" class="form-control" value="{{ old('e_image') }}"/></td>
