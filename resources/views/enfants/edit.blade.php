        ...
        <div class="card-body">
            ...
            <form action="{{ route('enfants.update', ['enfant'=>$enfant->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                @endif
                       ...
                       {{--  <div class="form-group">
                            <label for="ni">n°cnam</label>
                            <input id="ni" maxlength="8" required="required" type="text" name="num_cnam" placeholder="Entrer n°cnam" class="form-control" value="{{ old('nni', $enfant->num_cnam ?? null) }}"/>
                          </div> --}}
                        <div class="form-group">
